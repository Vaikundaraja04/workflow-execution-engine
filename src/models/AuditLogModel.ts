...
export const AUDIT_ACTIONS = [
  ...
  'MARKETPLACE_PRICING_UPDATED',
  'MARKETPLACE_PURCHASE_STARTED',
  'MARKETPLACE_PURCHASE_COMPLETED',
  'MARKETPLACE_LICENSE_ACTIVATED',
  'MARKETPLACE_LICENSE_RENEWED',
  'MARKETPLACE_LICENSE_REVOKED',
  'MARKETPLACE_REFUND_RECORDED',
  'MARKETPLACE_PAYOUT_RECORDED',
  'WORKFLOW_MARKETPLACE_PUBLISHED',
  'MARKETPLACE_WORKFLOW_INSTALLED',
  'MARKETPLACE_REVIEW_CREATED',
  'MARKETPLACE_REVIEW_HIDDEN',
  'MARKETPLACE_AI_COPY_GENERATED',
  'PARTNER_SOLUTION_PUBLISHED',
  'MARKETPLACE_ANALYTICS_VIEWED',
  ...
  'SLA_POLICY_CREATED',
  'SUPPORT_SLA_SWEEP_RUN',
  'SLA_BREACH_DETECTED',
  'COMPLIANCE_CENTER_VIEWED',
] as const;
