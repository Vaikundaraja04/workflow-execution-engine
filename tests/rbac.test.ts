...
const EXPECTED: Record<string, Permission[]> = {
  OWNER: [...PERMISSIONS],
  ADMIN: [...PERMISSIONS],
  EDITOR: ['WORKFLOW_CREATE', 'WORKFLOW_READ', 'WORKFLOW_UPDATE', 'WORKFLOW_EXECUTE', 'COLLABORATION_READ', 'COLLABORATION_COMMENT', 'OPERATIONS_READ', 'TEMPLATE_PUBLISH', 'GOVERNANCE_READ', 'AI_BUSINESS_READ'],
